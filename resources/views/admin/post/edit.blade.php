            ...
            <div class="card">
              ...
              <div class="form-group">
                <label for="tittle" class="form-control-label">Tittle</label>
                  <input type="text" id="tittle" name="tittle" value="{{$post->tittle}}" class="form-control" placeholder="Enter the tittle ..." >
              </div>
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  value="@foreach($post->tags as $key=>$tag) {{$key+1 < count ($post->tags) ? $tag->name. ',' : $tag->name}} 
                  @endforeach">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label>Body</label>
                    <textarea name="body" id="summernote" class="form-control" rows="3" placeholder="Enter ...">{{$post->body}}</textarea>
                </div>
