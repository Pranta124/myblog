        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    ...
                    <h6 class="text-white animated slideInDown">This page shows all the posts that available by the site</h6>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item bg-light">
                        ...
                        <div class="d-flex border-top">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-heart" aria-hidden="true"></i><a href="#">06 Likes</a></small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-comment" aria-hidden="true"></i><a href="#">02 Comments</a></small>
