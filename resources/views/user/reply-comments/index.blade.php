 ...
 <div class="content-header">
    <div class="container-fluid">
      ...
      <div class="col-md-12">
        ...
        <div class="col-sm-6">
          <h1 class="m-0">Replied Comments</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item active"><a href="#">Replied Comment</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="col-12">
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Replied-Comments Data</h3>
    </div>
       <!-- /.card-header -->
      <div class="card">
  ...
  <div class="row">
      ...
      <table id="example1" class="table table-bordered table-striped dataTable dtr-inline collapsed" role="grid" aria-describedby="example1_info">
                  ...
                  <tbody>
                    ...
                    <td><a href="">{{@$reply_comment->comment->post->tittle}}</a></td> 
                    <td>{{$reply_comment->created_at->diffForHumans()}}</td>
                    <td>
                      <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal-{{$reply_comment->id}}">
...
<div class="animated">
  ...
  <div class="modal fade" id="deleteModal-{{$reply_comment->id}}" tabindex="-1" role="dialog" aria-labelledby="Launch Secondary Modal"
      data-backdrop="static"   aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-tittle" id="Launch Default Modal">Delete Replied Comment</h5>
            <button type="button" class="close" data-dismiss="modal" aria-level="close">
              <span aria-hidden="true"></span>
            </button>
        </div>
